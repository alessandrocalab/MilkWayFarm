...
TABLE_NAME = 'REGISTRAZIONE_SENSORE'
ATTRIBUTES = ['SERIALE', 'DATA_SECONDI', 'NOME_PRODUTTORE', 'MISURAZIONE']

JSON_PATH = Path('python/make_DML/data/2_struttura/8_registrazione_sensore.json')
DML_PATH = Path('DB/DML/2_struttura/8_registrazione_sensore.sql')
