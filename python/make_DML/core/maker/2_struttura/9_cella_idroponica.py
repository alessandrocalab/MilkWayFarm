...
TABLE_NAME = 'CELLA_IDROPONICA'
ATTRIBUTES = ['CODICE_CELLA_IDR', 'CODICE_AREA', 'NOME_STRUTTURA', 'SISTEMA_IDROPONICO', 'DATA_SMONTAGGIO', 'DATA_MONTAGGIO', 'MAX_COLTURE']

JSON_PATH = Path('python/make_DML/data/2_struttura/9_cella_idroponica.json')
DML_PATH = Path('DB/DML/2_struttura/9_cella_idroponica.sql')
