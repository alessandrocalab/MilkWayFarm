...
TABLE_NAME = 'TIPO_SENSORE'
ATTRIBUTES = ['NOME_PRODUTTORE', 'NOME_MODELLO', 'VALORE_MIN', 'VALORE_MAX', 'PRECISIONE', 'GRANDEZZA_MISURATA', 'UNITA_MISURA', 'FREQUENZA_RILEVAMENTO_HZ']

JSON_PATH = Path('python/make_DML/data/2_struttura/6_tipo_sensore.json')
DML_PATH = Path('DB/DML/2_struttura/6_tipo_sensore.sql')
