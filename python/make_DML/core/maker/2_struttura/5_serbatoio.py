...
TABLE_NAME = 'SERBATOIO'
ATTRIBUTES = ['NUMERO_SERBATOIO', 'CODICE_AREA', 'NOME_STRUTTURA', 'DATA_SMONTAGGIO', 'DATA_MONTAGGIO', 'PRESSIONE_MAX_PA', 'DIMENSIONE_M3']

JSON_PATH = Path('python/make_DML/data/2_struttura/5_serbatoio.json')
DML_PATH = Path('DB/DML/2_struttura/5_serbatoio.sql')
