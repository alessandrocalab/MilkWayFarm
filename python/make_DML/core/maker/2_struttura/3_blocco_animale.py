...
TABLE_NAME = 'BLOCCO_ANIMALE'
ATTRIBUTES = ['NUMERO_BLOCCO', 'NOME_STRUTTURA', 'CODICE_AREA', 'DATA_SMONTAGGIO', 'SUPERFICIE_MQ', 'LIMITE_ALLOCAZIONE', 'DATA_MONTAGGIO']

JSON_PATH = Path('python/make_DML/data/2_struttura/3_blocco_animale.json')
DML_PATH = Path('DB/DML/2_struttura/3_blocco_animale.sql')
