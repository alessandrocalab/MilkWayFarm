...
TABLE_NAME = 'STRUTTURA'
ATTRIBUTES = ['NOME_STRUTTURA', 'DATA_TERMINAZIONE', 'QUOTA', 'LONGITUDINE', 'LATITUDINE', 'VOLUME_M3', 'SUPERFICIE_MQ', 'DATA_ATTIVAZIONE']

JSON_PATH = Path('python/make_DML/data/2_struttura/1_struttura.json')
DML_PATH = Path('DB/DML/2_struttura/1_struttura.sql')
