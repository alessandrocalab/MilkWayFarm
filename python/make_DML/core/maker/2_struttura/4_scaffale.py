...
TABLE_NAME = 'SCAFFALE'
ATTRIBUTES = ['NUMERO_SCAFFALE', 'CODICE_AREA', 'NOME_STRUTTURA', 'DATA_SMONTAGGIO', 'DATA_MONTAGGIO', 'CAPACITA_KG', 'DIMENSIONE_M3']

JSON_PATH = Path('python/make_DML/data/2_struttura/4_scaffale.json')
DML_PATH = Path('DB/DML/2_struttura/4_scaffale.sql')
