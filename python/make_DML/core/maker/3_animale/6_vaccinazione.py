...
TABLE_NAME = 'VACCINAZIONE'
ATTRIBUTES = ['ETICHETTA_ANIMALE', 'NOME_VACCINO', 'NOME_TIPO_ANIMALE', 'NOME_STADIO_CRESCITA', 'DATA_VACCINAZIONE']

JSON_PATH = Path('python/make_DML/data/3_animale/6_vaccinazione.json')
DML_PATH = Path('DB/DML/3_animale/6_vaccinazione.sql')
