...
TABLE_NAME = 'PRODUZIONE_ANIMALE'
ATTRIBUTES = ['DATA_PRODUZIONE', 'NUMERO_BLOCCO', 'NOME_STRUTTURA', 'CODICE_AREA', 'NOME_PRODOTTO', 'QUANTITA']

JSON_PATH = Path('python/make_DML/data/3_animale/9_produzione_animale.json')
DML_PATH = Path('DB/DML/3_animale/9_produzione_animale.sql')
