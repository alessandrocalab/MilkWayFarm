...
TABLE_NAME = 'VISITA_VETERINARIA'
ATTRIBUTES = ['ETICHETTA_ANIMALE', 'DATA_VISITA', 'STATO_SALUTE', 'TIPO_VISITA']

JSON_PATH = Path('python/make_DML/data/3_animale/7_visita_veterinaria.json')
DML_PATH = Path('DB/DML/3_animale/7_visita_veterinaria.sql')
