...
TABLE_NAME = 'PRESCRIZIONE_ANIMALE'
ATTRIBUTES = ['NOME_FARMACO', 'ETICHETTA_ANIMALE', 'DATA_VISITA', 'NOME_PRODOTTO', 'DURATA_GIORNI', 'QUANTITA_GIORNALIERA']

JSON_PATH = Path('python/make_DML/data/3_animale/8_prescrizione_animale.json')
DML_PATH = Path('DB/DML/3_animale/8_prescrizione_animale.sql')
