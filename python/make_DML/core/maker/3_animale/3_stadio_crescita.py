...
TABLE_NAME = 'STADIO_CRESCITA'
ATTRIBUTES = ['NOME_STADIO_CRESCITA', 'NOME_TIPO_ANIMALE', 'LIVELLO_BIOSICUREZZA_MINIMO', 'ETA_MINIMA_MESI']

JSON_PATH = Path('python/make_DML/data/3_animale/3_stadio_crescita.json')
DML_PATH = Path('DB/DML/3_animale/3_stadio_crescita.sql')
