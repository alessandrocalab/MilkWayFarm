...
TABLE_NAME = 'TIPO_ANIMALE'
ATTRIBUTES = ['NOME_TIPO_ANIMALE', 'SPECIE', 'VITA_MEDIA_ANNI', 'MODALITA_RIPRODUZIONE', 'GIORNI_GESTAZIONE', 'UMIDITA_IDEALE', 'SPAZIO_MINIMO_MQ', 'TEMPERATURA_IDEALE']

JSON_PATH = Path('python/make_DML/data/3_animale/1_tipo_animale.json')
DML_PATH = Path('DB/DML/3_animale/1_tipo_animale.sql')
