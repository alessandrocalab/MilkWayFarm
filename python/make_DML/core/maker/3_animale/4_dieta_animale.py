...
TABLE_NAME = 'DIETA_ANIMALE'
ATTRIBUTES = ['NOME_DIETA', 'OBIETTIVO_DIETA']

JSON_PATH = Path('python/make_DML/data/3_animale/4_dieta_animale.json')
DML_PATH = Path('DB/DML/3_animale/4_dieta_animale.sql')
