...
TABLE_NAME = 'TIPO_COLTURA'
ATTRIBUTES = ['NOME_TIPO_COLTURA', 'CATEGORIA_COLTURA', 'DURATA_CICLO_COLTURA_GIORNI']

JSON_PATH = Path('python/make_DML/data/4_agricoltura/2_tipo_coltura.json')
DML_PATH = Path('DB/DML/4_agricoltura/2_tipo_coltura.SQL')
