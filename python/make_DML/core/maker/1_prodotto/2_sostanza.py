...
TABLE_NAME = 'SOSTANZA'
ATTRIBUTES = ['NOME_SOSTANZA', 'IS_POTENZIALE_ALLERGENE', 'IS_POTENZIALE_INTOLLERANTE']

JSON_PATH = Path('python/make_DML/data/1_prodotto/2_sostanza.json')
DML_PATH = Path('DB/DML/1_prodotto/2_sostanza.sql')
