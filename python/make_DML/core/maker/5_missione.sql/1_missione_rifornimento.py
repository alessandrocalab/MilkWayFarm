...
TABLE_NAME = 'MISSIONE_RIFORNIMENTO'
ATTRIBUTES = ['NOME_MISSIONE', 'DATA_LANCIO', 'DATA_ARRIVO_PREVISTO', 'DATA_ARRIVO_EFFETTIVO', 'VOLUME_RIFORNIMENTO_M3', 'MASSA_RIFORNIMENTO_KG', 'BASE_PARTENZA']

JSON_PATH = Path('python/make_DML/data/5_missione.sql/1_missione_rifornimento.json')
DML_PATH = Path('DB/DML/5_missione.sql/1_missione_rifornimento.sql')
