...
TABLE_NAME = 'SERB_RISPETTA_MOD_CONS'
ATTRIBUTES = ['NUMERO_SERBATOIO', 'CODICE_AREA', 'NOME_STRUTTURA', 'NOME_CONSERVAZIONE']

JSON_PATH = Path('python/make_DML/data/6_associazioni/14_serb_rispetta_mod_cons.json')
DML_PATH = Path('DB/DML/6_associazioni/14_serb_rispetta_mod_cons.sql')
