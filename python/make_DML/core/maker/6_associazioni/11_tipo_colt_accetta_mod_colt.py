...
TABLE_NAME = 'TIPO_COLT_ACCETTA_MOD_COLT'
ATTRIBUTES = ['NOME_TIPO_COLTURA', 'NOME_MODALITA_COLTIVAZIONE']

JSON_PATH = Path('python/make_DML/data/6_associazioni/11_tipo_colt_accetta_mod_colt.json')
DML_PATH = Path('DB/DML/6_associazioni/11_tipo_colt_accetta_mod_colt.sql')
