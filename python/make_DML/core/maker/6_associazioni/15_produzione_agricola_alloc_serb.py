...
TABLE_NAME = 'PRODUZIONE_AGRICOLA_ALLOC_SERB'
ATTRIBUTES = ['DATA_PRODUZIONE_AGRICOLA', 'DATA_INIZIO_CICLO_COLTIVAZIONE', 'CODICE_CELLA_IDR', 'CODICE_AREA_CELLA', 'NOME_STRUTTURA_CELLA', 'NOME_PRODOTTO', 'NUMERO_SERBATOIO', 'CODICE_AREA_SERB', 'NOME_STRUTTURA_SERB', 'QUANTITA_ALLOCATA']

JSON_PATH = Path('python/make_DML/data/6_associazioni/15_produzione_agricola_alloc_serb.json')
DML_PATH = Path('DB/DML/6_associazioni/15_produzione_agricola_alloc_serb.sql')
