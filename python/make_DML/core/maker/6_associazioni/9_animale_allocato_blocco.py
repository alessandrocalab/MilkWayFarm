...
TABLE_NAME = 'ANIMALE_ALLOCATO_BLOCCO'
ATTRIBUTES = ['NUMERO_BLOCCO', 'NOME_STRUTTURA', 'CODICE_AREA', 'ETICHETTA_ANIMALE', 'DATA_ALLOCAZIONE', 'DATA_DEALLOCAIONE']

JSON_PATH = Path('python/make_DML/data/6_associazioni/9_animale_allocato_blocco.json')
DML_PATH = Path('DB/DML/6_associazioni/9_animale_allocato_blocco.sql')
