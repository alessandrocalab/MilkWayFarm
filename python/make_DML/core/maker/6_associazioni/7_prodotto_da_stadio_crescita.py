...
TABLE_NAME = 'PRODOTTO_DA_STADIO_CRESCITA'
ATTRIBUTES = ['NOME_PRODOTTO', 'NOME_STADIO_CRESCITA', 'NOME_TIPO_ANIMALE', 'QUANTITA_STIMATA_GIORNALIERA']

JSON_PATH = Path('python/make_DML/data/6_associazioni/7_prodotto_da_stadio_crescita.json')
DML_PATH = Path('DB/DML/6_associazioni/7_prodotto_da_stadio_crescita.sql')
