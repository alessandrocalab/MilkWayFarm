...
TABLE_NAME = 'PRODOTTO_PREVEDE_MOD_CONS'
ATTRIBUTES = ['NOME_CONSERVAZIONE', 'NOME_PRODOTTO']

JSON_PATH = Path('python/make_DML/data/6_associazioni/8_prodotto_prevede_mod_cons.json')
DML_PATH = Path('DB/DML/6_associazioni/8_prodotto_prevede_mod_cons.sql')
