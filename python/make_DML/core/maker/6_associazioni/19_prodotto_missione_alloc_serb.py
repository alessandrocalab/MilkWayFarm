...
TABLE_NAME = 'PRODOTTO_MISSIONE_ALLOC_SERB'
ATTRIBUTES = ['NOME_PRODOTTO', 'NOME_MISSIONE', 'NUMERO_SERBATOIO', 'CODICE_AREA_SERB', 'NOME_STRUTTURA_SERB', 'QUANTITA_ALLOCATA']

JSON_PATH = Path('python/make_DML/data/6_associazioni/19_prodotto_missione_alloc_serb.json')
DML_PATH = Path('DB/DML/6_associazioni/19_prodotto_missione_alloc_serb.sql')
