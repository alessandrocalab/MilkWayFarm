...
TABLE_NAME = 'DEALLOC_PROD_CICLO_COLT_SCAFF'
ATTRIBUTES = ['DATE_MIN', 'NOME_PRODOTTO', 'NUMERO_SCAFF', 'CODICE_AREA_SCAFF', 'NOME_STRUTTURA_SCAFF', 'DATA_INIZIO', 'CODICE_CELLA_IDR', 'CODICE_AREA_CELLA', 'NOME_STRUTTURA_CELLA', 'QUANTITA_DEALLOCATA']

JSON_PATH = Path('python/make_DML/data/6_associazioni/22_dealloc_prod_ciclo_colt_scaff.json')
DML_PATH = Path('DB/DML/6_associazioni/22_dealloc_prod_ciclo_colt_scaff.sql')
