...
TABLE_NAME = 'CELLA_IDR_RISPETTA_MOD_COLT'
ATTRIBUTES = ['CODICE_CELLA_IDR', 'CODICE_AREA', 'NOME_STRUTTURA', 'NOME_MOD_COLTIVAZIONE']

JSON_PATH = Path('python/make_DML/data/6_associazioni/10_cella_idr_rispetta_mod_colt.json')
DML_PATH = Path('DB/DML/6_associazioni/10_cella_idr_rispetta_mod_colt.sql')
