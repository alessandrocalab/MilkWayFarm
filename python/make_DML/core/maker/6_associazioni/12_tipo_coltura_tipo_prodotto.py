...
TABLE_NAME = 'TIPO_COLTURA_TIPO_PRODOTTO'
ATTRIBUTES = ['NOME_TIPO_COLTURA', 'NOME_PRODOTTO', 'QUANTITA_STIMATE_PER_KG_SEMI']

JSON_PATH = Path('python/make_DML/data/6_associazioni/12_tipo_coltura_tipo_prodotto.json')
DML_PATH = Path('DB/DML/6_associazioni/12_tipo_coltura_tipo_prodotto.SQL')
