...
with open("make_DML/data/6_associazioni/14_serb_rispetta_mod_cons.sql.json", "w", encoding="utf-8") as f:
   json.dump(theJsonList, f, indent=4, ensure_ascii=False)

make_DML("DB/DML/6_associazioni/14_serb_rispetta_mod_cons.sql.bak", lines)