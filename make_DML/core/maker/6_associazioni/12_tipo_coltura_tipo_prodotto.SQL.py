...
with open("make_DML/data/6_associazioni/12_tipo_coltura_tipo_prodotto.SQL.json", "w", encoding="utf-8") as f:
   json.dump(theJsonList, f, indent=4, ensure_ascii=False)

make_DML("DB/DML/6_associazioni/12_tipo_coltura_tipo_prodotto.SQL.bak", lines)