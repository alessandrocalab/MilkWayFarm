...
with open("make_DML/data/6_associazioni/21_dealloc_prod_ciclo_colt_serb.sql.json", "w", encoding="utf-8") as f:
   json.dump(theJsonList, f, indent=4, ensure_ascii=False)

make_DML("DB/DML/6_associazioni/21_dealloc_prod_ciclo_colt_serb.sql.bak", lines)