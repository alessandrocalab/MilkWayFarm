...
with open("make_DML/data/6_associazioni/16_produzione_agricola_alloc_scaff.sql.json", "w", encoding="utf-8") as f:
   json.dump(theJsonList, f, indent=4, ensure_ascii=False)

make_DML("DB/DML/6_associazioni/16_produzione_agricola_alloc_scaff.sql.bak", lines)