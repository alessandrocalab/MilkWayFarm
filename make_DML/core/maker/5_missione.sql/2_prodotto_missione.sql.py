...
with open("make_DML/data/5_missione.sql/2_prodotto_missione.sql.json", "w", encoding="utf-8") as f:
   json.dump(theJsonList, f, indent=4, ensure_ascii=False)

make_DML("DB/DML/5_missione.sql/2_prodotto_missione.sql.bak", lines)