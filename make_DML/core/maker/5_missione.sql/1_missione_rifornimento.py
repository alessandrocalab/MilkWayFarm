...
theDict=zip(NOME_MISSIONE, DATA_LANCIO, DATA_ARRIVO_PREVISTO, DATA_ARRIVO_EFFETTIVO, VOLUME_RIFORNIMENTO_M3, MASSA_RIFORNIMENTO_KG, BASE_PARTENZA)
...
make_DML("DB/DML5_missione.sql/1_missione_rifornimento.sql", lines)