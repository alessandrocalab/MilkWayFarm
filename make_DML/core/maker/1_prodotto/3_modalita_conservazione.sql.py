...
with open("make_DML/data/1_prodotto/3_modalita_conservazione.sql.json", "w", encoding="utf-8") as f:
   json.dump(theJsonList, f, indent=4, ensure_ascii=False)

make_DML("DB/DML/1_prodotto/3_modalita_conservazione.sql.bak", lines)