...
#MODALITA_COLTIVAZIONE:NOME_MODALITA_COLTIVAZIONE NOME_PRODOTTO PH_MIN PH_MAX TEMPERATURA_MIN TEMPERATURA_MAX UMIDITA_MIN UMIDITA_MAX IMPOLLINAZIONE SISTEMA_ILLUMINAZIONE ACQUA_ML_ORA ORE_LUCE_GIORNO QUANTITA_SOLUZIONE_ML_ORA 
