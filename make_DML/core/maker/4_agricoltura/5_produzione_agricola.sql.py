...
with open("make_DML/data/4_agricoltura/5_produzione_agricola.sql.json", "w", encoding="utf-8") as f:
   json.dump(theJsonList, f, indent=4, ensure_ascii=False)

make_DML("DB/DML/4_agricoltura/5_produzione_agricola.sql.bak", lines)