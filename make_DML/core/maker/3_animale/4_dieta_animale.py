...
#DIETA_ANIMALE:NOME_DIETA DATA_INIZIO_DIETA DATA_FINE_DIETA OBIETTIVO_DIETA 
...
theList=list(zip(NOME_DIETA, DATA_INIZIO_DIETA, DATA_FINE_DIETA, OBIETTIVO_DIETA))

keys = ["NOME_DIETA", "DATA_INIZIO_DIETA", "DATA_FINE_DIETA", "OBIETTIVO_DIETA"]
